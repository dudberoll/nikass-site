...
function NavigationMenuList({
  className,
  ...props
}: React.ComponentProps<typeof NavigationMenuPrimitive.List> & NoStyleOverrides) {
  return (
...
function NavigationMenuItem({
  className,
  ...props
}: React.ComponentProps<typeof NavigationMenuPrimitive.Item> & NoStyleOverrides) {
  return (
...
function NavigationMenuTrigger({
  ...
  children,
  ...props
}: React.ComponentProps<typeof NavigationMenuPrimitive.Trigger> & NoStyleOverrides) {
  return (
...
function NavigationMenuContent({
  className,
  ...props
}: React.ComponentProps<typeof NavigationMenuPrimitive.Content> & NoStyleOverrides) {
  return (
...
function NavigationMenuViewport({
  className,
  ...props
}: React.ComponentProps<typeof NavigationMenuPrimitive.Viewport> & NoStyleOverrides) {
  return (
    <div
      className={cn(
...
function NavigationMenuLink({
  ...
  variant = "default",
  ...props
}: React.ComponentProps<typeof NavigationMenuPrimitive.Link> & { variant?: "default" | "trigger" | "card" } & NoStyleOverrides) {
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        ...
        variant === "trigger" && navigationMenuTriggerStyle(),
        variant === "card" && "rounded-md p-3 hover:bg-accent",
        className
      )}
      {...props}
    />
...
function NavigationMenuIndicator({
  className,
  ...props
}: React.ComponentProps<typeof NavigationMenuPrimitive.Indicator> & NoStyleOverrides) {
  return (
