...
function ContextMenu({
  ...props
}: React.ComponentProps<typeof ContextMenuPrimitive.Root> & NoStyleOverrides) {
...
function ContextMenuTrigger({
  ...
  variant = "default",
  ...props
}: React.ComponentProps<typeof ContextMenuPrimitive.Trigger> & { variant?: "default" | "target" } & NoStyleOverrides) {
  return (
    <ContextMenuPrimitive.Trigger
      data-slot="context-menu-trigger"
      className={cn("select-none", variant === "target" && "grid h-40 place-items-center rounded-xl border border-dashed text-sm text-muted-foreground", className)}
      {...props}
    />
  )
}
...
function ContextMenuGroup({
  ...props
}: React.ComponentProps<typeof ContextMenuPrimitive.Group> & NoStyleOverrides) {
  return (
...
function ContextMenuPortal({
  ...props
}: React.ComponentProps<typeof ContextMenuPrimitive.Portal> & NoStyleOverrides) {
  return (
...
function ContextMenuSub({
  ...props
}: React.ComponentProps<typeof ContextMenuPrimitive.Sub> & NoStyleOverrides) {
  return <ContextMenuPrimitive.Sub data-slot="context-menu-sub" {...props} />
}

function ContextMenuRadioGroup({
  ...props
}: React.ComponentProps<typeof ContextMenuPrimitive.RadioGroup> & NoStyleOverrides) {
  return (
...
function ContextMenuSubContent({
  className,
  ...props
}: React.ComponentProps<typeof ContextMenuPrimitive.SubContent> & NoStyleOverrides) {
  return (
...
function ContextMenuSeparator({
  className,
  ...props
}: React.ComponentProps<typeof ContextMenuPrimitive.Separator> & NoStyleOverrides) {
  return (
