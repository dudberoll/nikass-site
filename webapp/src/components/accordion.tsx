...
function Accordion({
  className,
  ...props
}: React.ComponentProps<typeof AccordionPrimitive.Root> & NoStyleOverrides) {
  return (
...
function AccordionItem({
  className,
  ...props
}: React.ComponentProps<typeof AccordionPrimitive.Item> & NoStyleOverrides) {
  return (
...
function AccordionTrigger({
  ...
  children,
  ...props
}: React.ComponentProps<typeof AccordionPrimitive.Trigger> & NoStyleOverrides) {
  return (
...
function AccordionContent({
  ...
  children,
  ...props
}: React.ComponentProps<typeof AccordionPrimitive.Content> & NoStyleOverrides) {
  return (
