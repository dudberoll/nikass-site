...
function Menubar({
  className,
  ...props
}: React.ComponentProps<typeof MenubarPrimitive.Root> & NoStyleOverrides) {
  return (
...
function MenubarMenu({
  ...props
}: React.ComponentProps<typeof MenubarPrimitive.Menu> & NoStyleOverrides) {
  return <MenubarPrimitive.Menu data-slot="menubar-menu" {...props} />
}

function MenubarGroup({
  ...props
}: React.ComponentProps<typeof MenubarPrimitive.Group> & NoStyleOverrides) {
  return <MenubarPrimitive.Group data-slot="menubar-group" {...props} />
}

function MenubarPortal({
  ...props
}: React.ComponentProps<typeof MenubarPrimitive.Portal> & NoStyleOverrides) {
  return <MenubarPrimitive.Portal data-slot="menubar-portal" {...props} />
}

function MenubarRadioGroup({
  ...props
}: React.ComponentProps<typeof MenubarPrimitive.RadioGroup> & NoStyleOverrides) {
  return (
...
function MenubarTrigger({
  className,
  ...props
}: React.ComponentProps<typeof MenubarPrimitive.Trigger> & NoStyleOverrides) {
  return (
...
function MenubarContent({
  ...
  sideOffset = 8,
  ...props
}: React.ComponentProps<typeof MenubarPrimitive.Content> & NoStyleOverrides) {
  return (
    <MenubarPortal>
...
function MenubarSeparator({
  className,
  ...props
}: React.ComponentProps<typeof MenubarPrimitive.Separator> & NoStyleOverrides) {
  return (
...
function MenubarSub({
  ...props
}: React.ComponentProps<typeof MenubarPrimitive.Sub> & NoStyleOverrides) {
...
function MenubarSubContent({
  className,
  ...props
}: React.ComponentProps<typeof MenubarPrimitive.SubContent> & NoStyleOverrides) {
  return (
