...
function InputOTPGroup({ className, ...props }: React.ComponentProps<"div"> & NoStyleOverrides) {
  return (
    <div
...
function InputOTPSeparator({ ...props }: React.ComponentProps<"div"> & NoStyleOverrides) {
  return (
    <div
